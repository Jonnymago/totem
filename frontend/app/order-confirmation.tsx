  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      const orderItems = items.map(item => ({
        ...
        category_id: item.category_id || item.product_category_id,
        product_category_id: item.product_category_id || item.category_id,
      ...
      void (async () => {
        ...
        try {
          if (!s || s.auto_print_kitchen) {
            await printKitchenTicket(order, undefined, s || undefined);
          }
