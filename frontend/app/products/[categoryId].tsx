...
const styles = StyleSheet.create({
  ...
  badge: {
    position: 'absolute', top: 6, right: 6, backgroundColor: '#FFE66D',
    borderRadius: 14, minWidth: 28, height: 28, paddingHorizontal: 4,
    justifyContent: 'center', alignItems: 'center',
  },
  badgeText: { fontSize: 14, fontWeight: 'bold', color: '#FF6B6B' },
  content: { flex: 1 },
