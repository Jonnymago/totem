  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        {/* SEZIONE HARDWARE TOTEM & LICENZA */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            <Ionicons name="hardware-chip-outline" size={18} color="#FF6B6B" /> Sistema Totem & Hardware
          </Text>
          <Text style={[styles.hint, { marginTop: 0, marginBottom: 12 }]}>
            Configura il blocco schermo kiosk a pieno schermo, la diagnostica hardware e la licenza Google Play Store.
          </Text>

          <View style={styles.navCardsRow}>
            <TouchableOpacity
              style={styles.kioskNavCard}
              onPress={() => router.push('/admin/kiosk')}
            >
              <View style={styles.kioskNavIconBox}>
                <Ionicons name="tablet-portrait" size={22} color="#2563EB" />
              </View>
              <View style={{ flex: 1, minWidth: 0 }}>
                <Text style={styles.kioskNavTitle}>Modalità Kiosk & Blocco Totem</Text>
                <Text style={styles.kioskNavSub}>Blocco app, Keep Awake, Luminosità, Salvaschermo</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#94A3B8" />
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.licenseNavCard}
              onPress={() => router.push('/admin/license')}
            >
              <View style={styles.licenseNavIconBox}>
                <Ionicons name="ribbon" size={22} color="#059669" />
              </View>
              <View style={{ flex: 1, minWidth: 0 }}>
                <Text style={styles.licenseNavTitle}>Licenza, Abbonamenti & Note Legali</Text>
                <Text style={styles.licenseNavSub}>Stato abbonamento Google Play, GDPR, Guida</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#94A3B8" />
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.toggleRow} onPress={() => setKitchenDisplayEnabled(!kitchenDisplayEnabled)}>
            <View style={styles.toggleInfo}>
              <Text style={styles.toggleTitle}>Display Comande Cucina</Text>
            </View>
            <View style={[styles.switch, kitchenDisplayEnabled && styles.switchActive]}>
              <View style={[styles.switchThumb, kitchenDisplayEnabled && styles.switchThumbActive]} />
            </View>
          </TouchableOpacity>
          {kitchenDisplayEnabled && (
            <TouchableOpacity
              style={[styles.resetButton, { backgroundColor: '#FF6B6B', marginTop: 10 }]}
              onPress={() => router.push('/admin/kitchen')}
            >
              <Text style={styles.resetButtonText}>Apri Monitor Cucina</Text>
            </TouchableOpacity>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  pairedPrinterInfo: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10, minWidth: 0 },
  pairedPrinterIcon: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#E3F2FD', justifyContent: 'center', alignItems: 'center' },
  pairedPrinterName: { fontSize: 15, fontWeight: '600', color: '#333', flexShrink: 1 },
  ...
  printerRoles: { flexDirection: 'row', alignItems: 'center', gap: 8, flexWrap: 'wrap' },
  ...
  navCardsRow: { gap: 10, marginTop: 4 },
  kioskNavCard: {
    flexDirection: 'row',
    alignItems: 'center',
