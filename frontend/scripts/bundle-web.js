...
const remoteCandidates = [
  path.resolve(__dirname, '../../backend/static/remote/index.html'),
  path.resolve(__dirname, '../backend/static/remote/index.html'),
  path.resolve(__dirname, '../public/remote/index.html'),
  path.resolve(__dirname, '../public/admin/index.html'),
  path.resolve(__dirname, '../public/remote.html'),
  path.resolve(__dirname, '../public/admin.html'),
  path.resolve(rootDir, 'backend/static/remote/index.html'),
  path.resolve(rootDir, 'frontend/public/remote.html'),
  path.resolve(rootDir, 'public/remote.html')
];
const remoteSrc = remoteCandidates.find(p => fs.existsSync(p));

if (!remoteSrc) {
  console.warn('[bundle-web] Remote Admin source not found, skipping HTML injection');
